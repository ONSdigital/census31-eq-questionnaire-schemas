...
local englandDescriptionProxy = 'The next set of questions is about any qualifications <strong>{person_name}</strong> has ever achieved in England, Wales or worldwide, including equivalents, even if they are not using them now.';
...
local walesDescriptionProxy = 'The next set of questions is about any qualifications <strong>{person_name}</strong> has ever achieved in Wales, England or worldwide, including equivalents, even if they are not using them now.';
